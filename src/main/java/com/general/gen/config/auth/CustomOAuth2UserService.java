...
import com.general.gen.config.auth.dto.OAuthAttributes;
import com.general.gen.config.auth.dto.SessionUser;
import com.general.gen.domain.user.User;
import com.general.gen.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException{
        ...
        // 현재 로그인 진행 중인 서비스를 구분하는 코드. 네이버 로그인인지, 구글 로그인인지 구분하기 위해 사용한다.
